...
goctl-generator-compat-check: goctl-surface-drift-check goctl-api-flag-parity-check goctl-rpc-protoc-parity-check goctl-model-parity-replay-check api-client-generation-check api-client-toolchain-check api-semantic-parity-check zrpc-proto-compatibility-check ## Validate goctl-compatible generator tests
...
.PHONY: api-client-toolchain-check
...
command-config-family-preflight-check: ## Validate cmd/gofly config family split contracts after the physical move
