...
require(
    "assertRequiredFields(t, item.ID+\".data\", data, item.RequiredDataFields)" in test_file,
    "golden tests must assert required data fields through manifest-driven helper",
)
