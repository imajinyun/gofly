...
func releaseCheckOutputContract() *aiOutputContract {
	return &aiOutputContract{
		...
		Semantics: map[string]string{
			...
			"generatedRPCMuxRetryFamily":  "generated-rpc-mux-retry-smoke exposes generated project evidence for mux open-before retry, post-open no replay boundaries, and generated.rpcMuxConfigWarnings as a caller-consumable warning snapshot contract",
