...
func buildAIToolManifestCommands() []aiToolCommand {
	commands := []aiToolCommand{
		...
		manifestCommand("gateway aggregation validate", []string{"gateway aggregation diff"}, "Validate a candidate BFF aggregation contract against current gateway config or compare old/new OpenAPI x-gofly-aggregation contracts.", "gofly gateway aggregation validate --config <gateway.json> --route <route> --candidate <aggregation.json> [--openapi-base old.json --openapi-candidate new.json] [--format text|markdown|json] [--json]", map[string]aiInputProperty{"config": stringProperty("Gateway config JSON containing routes."), "route": stringProperty("Route name or route key to compare."), "candidate": stringProperty("Candidate aggregation JSON."), "openapi-base": stringProperty("Base OpenAPI JSON containing x-gofly-aggregation."), "openapi-candidate": stringProperty("Candidate OpenAPI JSON containing x-gofly-aggregation."), "format": enumStringProperty("Output format.", outputText, "markdown", outputJSON), "json": boolProperty("Print JSON envelope.")}, []string{outputText, "markdown", outputJSON}, []string{"reads gateway config and candidate aggregation files", "or reads base/candidate OpenAPI files"}, "read", true, false, []string{"gofly gateway aggregation validate --config etc/edge.json --route bff-home --candidate etc/edge-aggregation-candidate.json --json", "gofly gateway aggregation validate --openapi-base old-openapi.json --openapi-candidate new-openapi.json --route home --format markdown"}),
		manifestCommand("release check", nil, "Run release readiness checks and report machine-readable release gate evidence.", "gofly release check [--api-base <old.api> --api-target <new.api>] [--rpc-base <old.proto> --rpc-target <new.proto>] [--changelog CHANGELOG.md] [--evidence <check>] [--strict] [--json]", map[string]aiInputProperty{"api-base": stringProperty("Base .api file for breaking detection."), "api-target": stringProperty("Target .api file for breaking detection."), "rpc-base": stringProperty("Base protobuf file for breaking detection."), "rpc-target": stringProperty("Target protobuf file for breaking detection."), "changelog": stringProperty("Changelog file to inspect."), "evidence": stringProperty("Optional check name to return only that check's evidence."), "strict": boolProperty("Treat warnings as blockers."), "json": boolProperty("Print JSON envelope.")}, []string{outputText, outputJSON}, []string{"reads local contract, changelog, module, generated gateway evidence files"}, "read", true, false, []string{"gofly release check --json", "gofly release check --json --evidence gateway-aggregation-contract"}),
