...
func For(command string) Topic {
	...
	case "gateway aggregation", "gateway aggregation validate", "gateway aggregation diff":
		return Topic{Name: command, Short: "Validate a candidate gateway BFF aggregation contract.", Usage: "gofly gateway aggregation validate --config <gateway.json> --route <route> --candidate <aggregation.json> [--format text|json] [--json]", Flags: []string{"--config <file>     gateway config JSON containing routes", "--route <route>     route name or route key", "--candidate <file>  candidate aggregation JSON", "--format <format>   output format: text or json", "--json              output JSON envelope"}, Examples: []string{"gofly gateway aggregation validate --config etc/edge.json --route bff-home --candidate candidate-aggregation.json --json", "gofly gateway aggregation diff etc/edge.json candidate-aggregation.json --route bff-home --format json"}}
	case "version":
