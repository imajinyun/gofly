	...
	case "api go":
		return Topic{
			...
			Flags: []string{
				...
				"--style go_zero                  alias for --profile gozero-compatible",
				"--profile <profile>              gofly-ai|gozero-compatible|kitex-compatible",
				"--test                           generate handler smoke tests",
				"--type-group                     group DTO files by @server group",
