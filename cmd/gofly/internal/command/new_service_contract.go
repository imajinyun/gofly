...
func applyNewServiceContractInputs(inputs newServiceContractInputs, serviceName, dir string) error {
	...
	if protoContract != "" {
		if err := generator.GenerateRPCFromProto(generator.RPCOptions{ProtoFile: protoContract, Dir: filepath.Join(dir, "internal", "api", "grpc"), Package: "rpc", WithMiddleware: true, WithRecovery: true, WithValidator: true}); err != nil {
