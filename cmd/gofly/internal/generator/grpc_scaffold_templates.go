...
const goZeroRPCServerTemplate = `package greeterrpc
...
const goZeroRPCServerTestTemplate = `package greeterrpc
...
const goZeroRPCClientTemplate = `package greeterrpc
...
import (
	...
	appdiscovery "{{.Module}}/internal/discovery"
	apprpc "{{.Module}}/internal/api/grpc/v1"
	"{{.Module}}/internal/svc"
)
...
func main() {
	...
	apprpc.RegisterServices(grpcServer.GRPCServer(), stx)
...
const goZeroRPCRegisterTemplate = `// Code generated by gofly. DO NOT EDIT.

package rpcv1

import (
	"google.golang.org/grpc"
	greeterrpc "{{.Module}}/internal/api/grpc/v1/greeter"
	"{{.Module}}/internal/pb"
	"{{.Module}}/internal/svc"
)

func RegisterServices(registrar grpc.ServiceRegistrar, stx *svc.ServiceContext) {
	pb.RegisterGreeterServer(registrar, greeterrpc.NewGreeterServer(stx))
}
