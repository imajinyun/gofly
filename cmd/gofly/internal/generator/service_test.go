...
func TestGenerateService(t *testing.T) {
	...
	for _, want := range []string{"securityHeaders", "change-me-admin-token", "fileSecretRoot", "real mux subprocess profile must not be generated by default", "kind: NetworkPolicy", "kind: HorizontalPodAutoscaler", "ServiceMonitor", "logs-correlation.yaml", "Logs by trace_id", "trace_id"} {
