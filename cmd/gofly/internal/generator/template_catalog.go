	...
	return []ProjectTemplate{
		{
			...
			Files:              []string{".gofly/config.json", "go.mod", "cmd/<name>-api/main.go", "etc/<name>.json", "docs/openapi.yaml", "internal/config/config.go", "internal/observability/observability.go", "internal/routes/routes.go", "internal/app/ping.go"},
		...
		},
		{
			...
			Inputs:              commonTemplateInputs(),
			Files:               []string{".gofly/config.json", "go.mod", "cmd/<name>-grpc/main.go", "<name>.proto", "Dockerfile", ".github/workflows/ci.yml", "internal/admin/admin.go", "internal/observability/observability.go", "internal/api/grpc/v1/register.gen.go", "internal/api/grpc/v1/greeter/greeter.go"},
			Verify:              []string{"gofmt", "go mod tidy", "go test ./..."},
			VerifyE2EValidated:  true,
			RiskLevel:           "medium",
		...
		},
		{
			...
			Inputs:             commonTemplateInputs(),
			Files:              []string{".gofly/config.json", "go.mod", "cmd/<name>-api/main.go", "etc/<name>.json", "internal/config/config.go", "internal/routes/routes.go", "internal/app/ping.go"},
			Verify:             []string{"gofmt", "go mod tidy", "go test ./..."},
			VerifyE2EValidated: true,
			RiskLevel:          "medium",
			Command:            "gofly new api <name> --module <module> --style minimal --dir <dir>",
		...
		},
		{
			...
			Files:              []string{".gofly/config.json", "go.mod", "cmd/<name>/main.go", "Dockerfile", ".github/workflows/ci.yml", "internal/ai/rag.go", "internal/observability/observability.go", "internal/routes/routes.go", "internal/app/ping.go"},
			Verify:             []string{"gofmt", "go mod tidy", "go test ./..."},
			VerifyE2EValidated: true,
			RiskLevel:          "medium",
			Command:            "gofly new service <name> --module <module> --style production --dir <dir>",
