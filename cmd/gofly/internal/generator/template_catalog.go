	...
	return []ProjectTemplate{
		{
			...
			Files:        []string{"go.mod", "cmd/<name>/main.go", "etc/<name>.json", "internal/config/config.go", "internal/routes/routes.go", "internal/service/ping.go"},
			Verify:       []string{"gofmt", "go test ./..."},
			RiskLevel:    "medium",
		...
		},
		{
			...
			Files:        []string{"go.mod", "cmd/<name>/main.go", "Dockerfile", ".github/workflows/ci.yml", "internal/config/config.go", "internal/routes/routes.go"},
		...
		},
		{
			...
			Inputs:       commonTemplateInputs(),
			Files:        []string{"go.mod", "cmd/<name>/main.go", "<name>.proto", "internal/rpc/greeter.go", "internal/admin/admin.go"},
			Verify:       []string{"gofmt", "go test ./..."},
			RiskLevel:    "medium",
		...
		},
		{
			...
			Files:        []string{"go.mod", "cmd/<name>/main.go", "etc/<name>.json", "internal/mq/broker.go", "etc/governance.json"},
			Verify:       []string{"gofmt", "go test ./..."},
			RiskLevel:    "medium",
		...
		},
		{
			...
			Inputs:       commonTemplateInputs(),
			Files:        []string{"go.mod", "cmd/<name>/main.go", "internal/command/root.go", "Makefile"},
			Verify:       []string{"gofmt", "go test ./..."},
			RiskLevel:    "medium",
			Command:      "gofly new api <name> --module <module> --style minimal --dir <dir>",
		},
		{
			...
			Inputs:       commonTemplateInputs(),
			Files:        []string{"go.mod", "cmd/<name>/main.go", "internal/gateway", "internal/routes"},
			Verify:       []string{"gofmt", "go test ./..."},
			RiskLevel:    "medium",
		...
		},
		{
			...
			Inputs:       commonTemplateInputs(),
			Files:        []string{".gofly/config.json", "go.mod", "cmd/<name>/main.go", "internal/config/config.go"},
			Verify:       []string{"gofmt", "go test ./...", "gofly ai doctor --json"},
			RiskLevel:    "medium",
			Command:      "gofly new api <name> --module <module> --style production --dir <dir>",
		},
		{
			...
			Files:        []string{".gofly/config.json", "go.mod", "cmd/<name>/main.go", "internal/service", "internal/routes"},
			Verify:       []string{"gofmt", "go test ./..."},
			RiskLevel:    "medium",
			Command:      "gofly new api <name> --module <module> --style production --dir <dir>",
		},
