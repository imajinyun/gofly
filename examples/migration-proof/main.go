	...
	cases := []migrationCase{
		{
			...
			Compatibility:        []string{"examples/restserver", "make examples-smoke"},
		...
		},
		{
			...
			Compatibility:        []string{"examples/production-orders", "make generated-version-compat-check", "make reference-app-smoke"},
		...
		},
		{
			...
			Compatibility:        []string{"examples/microshop", "make cloud-native-render-check"},
		...
		},
		{
			...
			Compatibility:        []string{"examples/rpc-idl-matrix", "make rpc-boundary-check", "make bench-evidence-check"},
