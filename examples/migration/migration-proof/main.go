...
func buildReport() report {
	cases := []migrationCase{
		{
			...
			Validation: []string{
				...
				"go run -C examples/getting-started/restserver .",
			...
			Compatibility:        []string{"examples/getting-started/restserver", "make examples-smoke"},
		...
		},
		{
			...
			Example:       "examples/migration/gozero-basic",
			Contract:      "goctl-compatible layout mapping, ServiceContext entrypoint, replay evidence, and zRPC boundary review",
			Validation: []string{
				"go test -C examples/migration/gozero-basic ./...",
				"go run -C examples/migration/gozero-basic .",
			...
			Compatibility:        []string{"examples/migration/gozero-basic", "make goctl-generator-compat-check", "make goctl-real-project-replay-check"},
		...
		},
		{
			...
			Validation: []string{
				"go test -C examples/production/microshop ./...",
				"go run -C examples/production/microshop describe",
			},
			GateCommands: []string{
			...
			Compatibility:        []string{"examples/production/microshop", "make cloud-native-render-check"},
		...
		},
		{
			...
			Validation: []string{
				"go test -C examples/microservices/rpc-idl-matrix ./...",
				"go run -C examples/microservices/rpc-idl-matrix .",
			...
			Compatibility:        []string{"examples/microservices/rpc-idl-matrix", "make rpc-boundary-check", "make bench-evidence-check"},
	...
	return report{
		Schema:              schema,
		Cases:               cases,
		Smoke:               []string{"make examples-smoke", "make test-generated-matrix"},
		Rollbacks:           rollbacks,
