...
func buildReport() report {
	cases := []migrationCase{
		...
		},
		{
			...
			Validation: []string{
				"go test -C examples/production/production-orders ./...",
				"go run -C examples/production/production-orders .",
			...
			Compatibility:        []string{"examples/production/production-orders", "make generated-version-compat-check", "make reference-app-smoke"},
