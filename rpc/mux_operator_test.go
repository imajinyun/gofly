...
func TestRPCMuxDiagnosisOperatorHistoryLimits(t *testing.T) {
	...
	// Golden contract for external control-plane/release consumers. Additive
	// fields require a compatibility note and a consumer migration window before
	// this expected JSON changes.
